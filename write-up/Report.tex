...
The normal map generated for images when given larger input dimensions seem to have more clearly defined edges and surface contouring. Details on the evaluation of the two different models (trained on ScanNet and NYUv2 respectively) are in section 2.5.
