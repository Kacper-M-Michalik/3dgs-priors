...
compared to current case, where the neural network needs to learn the geometric features itself.
...
due to time constraints, and the selcted segmetnation model not providing tokens in the end
we diud not implement the cross attention method
\newline
