...
\noindent 
The Splatter Image model in fully implemented using PyTorch. The \verb|train.py|
...
We could also use the SOD models we tested in \textbf{Section \ref{sec:segmentation}: Segmentation and Salient Object Detection Exploration} to generate binary masks and use them as priors to augment our model and see how they affect our model.
