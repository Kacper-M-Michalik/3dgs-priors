...
the specific channel dimensions of the Splatter Image architecture (further details can be found in \textbf{Section \ref{sec:lora}: Manual LoRA Integration}).
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{report/images/Validation_loss_comparison_PSNR_novel.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{report/images/Validation_loss_comparison_SSIM_novel.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{report/images/Validation_loss_comparison_LPIPS_novel.png}
    \caption{Validation LPIPS from 5000-10000 iterations}
    \label{fig:val_lpips}
\end{figure}

When considering LoRA, the validation metrics from 5 to 10,000 iterations of finetuning reveal a distinct plateau, as we can note the y-axis scale as being extremely tight. Despite testing different rank configurations, we reached what appears to be the convergence limit of the weights early in the fine-tuning process, although it would be beneficial to confirm this by carrying on for longer or confirm this with other configurations. These metrics are discussed further in \textbf{Section \ref{sec:lora_results}: LoRA Experiment Results}.
