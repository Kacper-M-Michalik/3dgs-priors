...
At the final layer a convolution is used to map each feature vector to the desired number of classes. WHAT
...
\noindent
Another method for multimodal input consider is cross attention.
