...
\noindent
For evaluation code, changes include adding support for loading our pretrained models available on HuggingFace.
...
\noindent
Input preparation also was changed, namely priors are concatenated (if enabled) as additional channels to the input RGB images,
before being fed into the network. Assertions are also performed to verify that priors are indeed available for the currently
active dataset.
