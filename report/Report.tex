...
a pipeline that executes the prior generation scripts and constructs a ready-to-use dataset. Implementation details can be found in 
...
The existing Splatter Image training and evaluation scripts needed minimal changes, thanks to how we integrated our priors into the project.
The first change to 
