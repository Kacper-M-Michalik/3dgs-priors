...
\noindent
By performing our ablation study, we determined that Splatter Image performed best when augmented with both depth and normal maps, showing that both priors are very useful for informing the model about how to reconstruct unseen parts of the input image. We also found that LoRA finetuning also gave improved results while being efficient, over training of a few thousand iterations and fewer parameters updated than in the full model case. 
