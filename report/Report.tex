...
Namely, in 2020 Neural Radiance Fields\cite{nerf} (NeRF) introduced a revolutionary method for 3D reconstruction
...
(NOTE TODO: for now this only talks mostly about over-smooth geometry and kind of hallucinations, still looking for a layout/scale drift one). 
\newline
...
before being fed into the network. Splatter Image uses the Torch DataLoader alongside custom Dataset objects 
...
\verb|srn_priors.py| that provides new priors as new key/value pairs in the returned dictionary.
