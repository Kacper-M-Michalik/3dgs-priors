...
\noindent
The primary challenge of single-view reconstruction lies in novel view synthesis (which is consequently the focus of \textbf{Section 3.4: Quantitative Results}), where the model must infer occluded geometry without direct data. Figure \ref{fig:novel_comparison} illustrates this capability.
