...
Recent examples include ExScene\cite{exscene}, Wonderland\cite{wonderland}, F3D-Gaus\cite{f3dgaus}, Gauss VideoDreamer\cite{hao2025gaussvideodreamer3dscenegeneration}, TGS\cite{tgs} and Splatter Image\cite{splatterImage}.
...
\begin{minipage}[t]{0.16\textwidth}
    \textbf{srn\_cars\_intrins} \hrule \vspace{5pt}
...
\hfill
\begin{minipage}[t]{0.16\textwidth}
    \textbf{srn\_cars\_poses} \hrule \vspace{5pt}
    \footnotesize\ttfamily
    oid : uuid \\
    uid : int \\
    amt : float
...
\hfill
\begin{minipage}[t]{0.16\textwidth}
    \textbf{srn\_cars\_rgbs} \hrule \vspace{5pt}
    \footnotesize\ttfamily
    sku : str \\
    cost : float \\
    qty : int
...
\hfill
\begin{minipage}[t]{0.16\textwidth}
    \textbf{srn\_cars\_depths} \hrule \vspace{5pt}
    \footnotesize\ttfamily
    ts : time \\
    err : str \\
    code : int
...
\hfill
\begin{minipage}[t]{0.16\textwidth}
    \textbf{srn\_cars\_normals} \hrule \vspace{5pt}
    \footnotesize\ttfamily
    ver : float \\
    auth : str \\
    hash : hex
