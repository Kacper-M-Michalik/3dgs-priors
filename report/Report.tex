...
This made our search for priors models difficult and time consuming, on a already very time stretched project.
\newline
...
could be implemented in the future, and then these approaches could be comapred to see which is most useful for Splatter Image.
